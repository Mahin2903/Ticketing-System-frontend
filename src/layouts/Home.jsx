...
const STEPS = [
  {
    ...
    label: "Sign in",
    detail:
      "Authenticate with your JUST Google Workspace account — no separate registration needed.",
    color: "#a78bfa",
    icon: (
      <svg
        width="20"
  ...
  },
  {
    ...
    detail:
      "Fill in subject, priority, department, help topic, and a rich-text description of your issue.",
    color: "#f472b6",
    icon: (
      <svg
        width="20"
  ...
  },
  {
    ...
    detail:
      "A unique ticket ID and timestamp are generated instantly. Your resolution timer begins.",
    color: "#fb923c",
    icon: (
      <svg
        width="20"
  ...
  },
  {
    ...
    detail:
      "An ICT support agent claims your ticket. You receive an instant notification.",
    color: "#34d399",
    icon: (
      <svg
        width="20"
  ...
  },
  {
    ...
    detail:
      "Track progress in real time — In Progress or Pending, with live timer data throughout.",
    color: "#60a5fa",
    icon: (
      <svg
        width="20"
  ...
  },
  {
    ...
    detail:
      "Resolution time is logged. Review the fix, close the ticket, and leave your feedback.",
    color: "#a3e635",
    icon: (
      <svg
        width="20"
...
const StepCard = ({ step, index }) => (
  ...
  >
    ...
    <div
      ...
      style={{
        background: `radial-gradient(ellipse at top left, ${step.color}12 0%, transparent 65%)`,
      }}
    />
      ...
      <section className="min-h-screen flex overflow-hidden">
        ...
        <div className="flex-1 flex items-center justify-center p-8 lg:p-14 xl:p-20 relative">
          ...
          >
            ...
            >
              The official support portal for Jashore University of Science
              &amp; Technology — fast, transparent, and available around the
              clock.
            </motion.p>
            ...
            >
              ...
              <motion.button
                onClick={() => navigate("/dashboard/user-dashboard-history")}
            ...
            >
              {STATS.map(({ value, label }) => (
                <div key={label}>
                  ...
                  <p className="text-white/30 text-[11px] mt-1.5 tracking-wide">
                    {label}
                  </p>
                </div>
              ))}
        ...
        >
          ...
          >
            ...
            <p className="text-white font-bold text-[1.05rem] leading-none">
              24 / 7
            </p>
      ...
      <section className="py-24 px-5 lg:px-12 relative">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-14" ref={sectionHeaderRef}>
            <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-violet-500/25 bg-violet-500/10 text-violet-300/80 text-[12px] font-medium tracking-[0.18em] uppercase">
            ...
            <p className="text-white/35 text-[13.5px] max-w-xs mx-auto leading-relaxed">
              Six transparent steps — so you always know exactly where your
              ticket stands.
            </p>
          </div>
